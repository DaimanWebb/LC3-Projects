...
.ORIG x3000                   ; start the program at x3000
        ...
        LD R2,  PTR           ; LD WILL LOAD INTO R2 THE VALUE HELD AT THE ADDRESS LABELED BY PTR
...
PTR     .FILL   x3100         ; PTR holds the address of the first number to add          
        .END  
...
; ORIGINALLY, x3100 LOADED VIA PC + x0FC OFFSET WITH LEA

; NOW, WE USE A LABEL PTR TO HOLD THE ADDRESS x3100; LOAD R2 WITH x3100 VIA LD INSTRUCTION
